...
namespace Hritcu_DragosCristian_Lab2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Hritcu_DragosCristian_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Hritcu_DragosCristian_Lab2Context context,
